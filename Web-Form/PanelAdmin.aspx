        ...
        <div class="col-2 h-100">
            <div class="h-100">
                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark h-100">
                    ...
                    <hr>
                    <div class="h-50">
                        <div class="d-grid gap-4 mb-5 mt-5">
        ...
        <div class="col-10">
            ...
            <div class="row mb-4 mt-4">
                ...
                <div class="col-8 d-flex align-items-center ">
                    ...
                    <asp:TextBox ID="txtFiltroRapidoProfesionales" CssClass="form-control mx-3" runat="server" AutoPostBack="true"
                        OnTextChanged="txtFiltroRapidoProfesionales_TextChanged"></asp:TextBox>
                </div>
                <div class=" col-2">
            ...
            <div class="row mt-5">
                ...
                <asp:GridView ID="dgvProfesionales" CssClass="table table-striped table-hover" runat="server" AutoGenerateColumns="false"
                    DataKeyNames="IdProfesional" OnRowCommand="dgvProfesionales_RowCommand">
                    <Columns>
                        <asp:BoundField DataField="Nombre" HeaderText="Nombre" />
                        <asp:BoundField DataField="Apellido" HeaderText="Apellido" />
                        <asp:BoundField DataField="Dni" HeaderText="DNI" />
