    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="mb-3">
                ...
                <asp:TextBox ID="txbNombre" runat="server" class="form-control" placeholder="Nombre..." required TabIndex="1"></asp:TextBox>
            </div>
            <div class="mb-3">
                <label for="txbDNI" class="form-label">DNI:</label>
                <asp:TextBox ID="txbDNI" runat="server" class="form-control" placeholder="DNI" required TabIndex="3"></asp:TextBox>
            </div>
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txbMail" runat="server" class="form-control" placeholder="nombre@mail.com" required TabIndex="11"></asp:TextBox>
            </div>
            <div class="mb-3">
        ...
        <div class="col-3">
            <div class="mb-3">
                ...
                <asp:TextBox ID="txbApellido" runat="server" class="form-control" placeholder="Apellido..." required TabIndex="2"></asp:TextBox>
            </div>
            <div class="mb-3">
                <label for="txbFechaNacimiento" class="form-label">Fecha de nacimiento:</label>
                <asp:TextBox ID="txbFechaNacimiento" TextMode="Date" runat="server" class="form-control" placeholder="" required TabIndex="4"></asp:TextBox>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <asp:TextBox ID="txbPass" runat="server" class="form-control" placeholder="" type="password" required TabIndex="12"></asp:TextBox>
            </div>
            <div class="mb-3 d-flex flex-column">
                <asp:Label Text="" ID="lblPassValidacion" CssClass="form-label" runat="server" />
                <asp:Button ID="btnCrear" runat="server" Text="Crear" class="btn btn-primary" OnClick="btnCrear_Click" TabIndex="20" ViewStateMode="Disabled"/>
            </div>
        </div>
        <div class="col-6">
